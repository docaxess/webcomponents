          ...
          <div class="login">
            ...
            <form part="login-form">
              <div class="input">
                ...
                <div class="input_btn">
                  <input part="username-input" class="input__input" type="text" id="username" name="username" value="" placeholder="Type your username here...">
                </div>
              </div>
              <div class="input">
                ...
                <div class="input_btn">
                  <input part="password-input" class="input__input" type="password" required id="password" name="password" value="" placeholder="Type your password here...">
