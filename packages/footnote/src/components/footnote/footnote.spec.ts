            ...
            <mock:shadow-root>
                ...
                <span id="footnote-label-1" class="footnote-id">[1]</span>
                    <div class="text">
                        ...
                        <a href="#ref1" aria-label="Back to main text"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
